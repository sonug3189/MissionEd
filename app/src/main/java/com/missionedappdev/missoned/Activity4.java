...
public class Activity4 extends AppCompatActivity implements physics_itemAdapter.ItemClicked {
    ...
    public void onItemClicked(int index) {
        ...
        Intent chapIntent=new Intent(Activity4.this,activity_chapter.class);
        chapIntent.putExtra("CHAPTER_INDEX",index);
        chapIntent.putExtra("SUBJECT","BIOLOGY");
